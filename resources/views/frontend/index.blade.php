@extends('frontend.website_master')
@section('content')
	        ...
	        <div class="row align-items-center">
	            <div class="col-lg-6">
	                <ul class="about__icons__wrap">
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/xd_light.png')}}" alt="XD">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/xd.png')}}" alt="XD">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/skeatch_light.png')}}" alt="Skeatch">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/skeatch.png')}}" alt="Skeatch">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/illustrator_light.png')}}" alt="Illustrator">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/illustrator.png')}}" alt="Illustrator">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/hotjar_light.png')}}" alt="Hotjar">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/hotjar.png')}}" alt="Hotjar">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/invision_light.png')}}" alt="Invision">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/invision.png')}}" alt="Invision">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/photoshop_light.png')}}" alt="Photoshop">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/photoshop.png')}}" alt="Photoshop">
	                    </li>
	                    <li>
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/figma_light.png')}}" alt="Figma">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/figma.png')}}" alt="Figma">
	                    </li>
	                </ul>
	            </div>
	                        @php
              $id = Auth::user()->id;
              $aboutData = App\Models\About::find($id);
            @endphp 
	            <div class="col-lg-6">
	                <div class="about__content">
	                    ...
	                    <div class="about__exp">
	                        <div class="about__exp__icon">
	                            <img src="{{ URL::to('frontend/assets/img/icons/about_icon.png')}}" alt="">
	                        </div>
	    ...
	    <div class="container">
	        ...
	        <div class="row gx-0 services__active">
	            <div class="col-xl-3">
	                <div class="services__item">
	                    <div class="services__thumb">
	                        <a href="services-details.html"><img src="{{ URL::to('frontend/assets/img/images/services_img01.jpg')}}" alt=""></a>
	                    </div>
	                    <div class="services__content">
	                        <div class="services__icon">
	                            <img class="light" src="{{ URL::to('frontend/assets/img/icons/services_light_icon01.png')}}" alt="">
	                            <img class="dark" src="{{ URL::to('frontend/assets/img/icons/services_icon01.png')}}" alt="">
	                        </div>
	            ...
	            <div class="col-xl-3">
	                <div class="services__item">
	                    <div class="services__thumb">
	                        <a href="services-details.html"><img src="{{ URL::to('frontend/assets/img/images/services_img02.jpg')}}" alt=""></a>
	                    </div>
	                    <div class="services__content">
	                        <div class="services__icon">
	                            <img class="light" src="{{ URL::to('frontend/assets/img/icons/services_light_icon02.png')}}" alt="">
	                            <img class="dark" src="{{ URL::to('frontend/assets/img/icons/services_icon02.png')}}" alt="">
	                        </div>
	            ...
	            <div class="col-xl-3">
	                <div class="services__item">
	                    <div class="services__thumb">
	                        <a href="services-details.html"><img src="{{ URL::to('frontend/assets/img/images/services_img03.jpg')}}" alt=""></a>
	                    </div>
	                    <div class="services__content">
	                        <div class="services__icon">
	                            <img class="light" src="{{ URL::to('frontend/assets/img/icons/services_light_icon03.png')}}" alt="">
	                            <img class="dark" src="{{ URL::to('frontend/assets/img/icons/services_icon03.png')}}" alt="">
	                        </div>
	            ...
	            <div class="col-xl-3">
	                <div class="services__item">
	                    <div class="services__thumb">
	                        <a href="services-details.html"><img src="{{ URL::to('frontend/assets/img/images/services_img04.jpg')}}" alt=""></a>
	                    </div>
	                    <div class="services__content">
	                        <div class="services__icon">
	                            <img class="light" src="{{ URL::to('frontend/assets/img/icons/services_light_icon04.png')}}" alt="">
	                            <img class="dark" src="{{ URL::to('frontend/assets/img/icons/services_icon04.png')}}" alt="">
	                        </div>
	        ...
	        <div class="row work__process__wrap">
	            <div class="col">
	                <div class="work__process__item">
	                    ...
	                    <div class="work__process__icon">
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/wp_light_icon01.png')}}" alt="">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/wp_icon01.png')}}" alt="">
	                    </div>
	            ...
	            <div class="col">
	                <div class="work__process__item">
	                    ...
	                    <div class="work__process__icon">
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/wp_light_icon02.png')}}" alt="">
	                        <img class="dark" src="{{ URL::to('frontend/assets/img/icons/wp_icon02.png')}}" alt="">
	                    </div>
	                    <div class="work__process__content">
	            ...
	            <div class="col">
	                <div class="work__process__item">
	                    ...
	                    <div class="work__process__icon">
	                        <img class="light" src="{{ URL::to('frontend/assets/img/icons/wp_light_icon03.png')}}" alt="">
